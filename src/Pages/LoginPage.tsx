...
//     try {
//       // 1. AUTHENTICATION: Check email and password
//       const {
//         data: { user },
//         error: authError,
...
//       if (user) {
//         // 2. GATEKEEPER: Check the 'profiles' table for account status
...
//         // 3. ENFORCE STATUS: Block access if not 'active'
//         if (profile.status !== "active") {
//           // Log them out immediately so they don't have a valid session
//           await supabase.auth.signOut();

//           // Customize the error message based on the status
...
//           ) {
//             statusMessage =
//               "This account has been locked for security purposes.";
//           }
